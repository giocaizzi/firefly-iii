...
/**
 * Authenticated user's active budgets (WIP_MCP D-011, §5.2).
 *
 * Scoped to auth()->user() (C9). BudgetEnrichment hydrates the meta blob
 * BudgetTransformer expects (currency, auto-budget, spent aggregates); output flows
 * through JsonApiReducer (D-034, drop nulls per D-035).
 */
#[Uri('firefly-iii://user/budgets')]
#[MimeType('application/json')]
#[Description("The authenticated user's active budgets.")]
final class UserBudgetsResource extends Resource
{
