...
/**
 * Static catalog of every transaction type known to this Firefly III instance.
 *
 * TransactionType has no public Fractal transformer, so a thin inline JSON:API shape is fed
 * through JsonApiReducer. The table only stores the type label beyond timestamps.
 */
