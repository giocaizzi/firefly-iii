...
#[Description('Per-currency total income into asset accounts over a date range. Mirrors /api/v1/insight/income/total.')]
#[IsReadOnly]
#[IsIdempotent]
final class InsightIncomeTool extends AbstractMcpTool
{
    public function handle(Request $request): Response
    {
        ...
        $rows       = $summariser->incomeTotal($start, $end, $accounts);
