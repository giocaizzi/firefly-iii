...
/**
 * Shared logic for MCP write tools.
 *
...
trait WritesTransactions
{
    ...
    /**
     * Audit-log a write failure — no payload, just the stage and exception message.
     */
     ...
     *
     * Maps the MCP arg shape (with both `*_id` and `*_name` for relations)
     ...
     *
     * Used by CreateWithdrawalTool, CreateDepositTool, CreateTransferTool. Transfer-only
     ...
     *
     * Returns null for fresh / cross-user keys (defensive isolation).
     */
    ...
    /**
     * Cross-currency guard for transfers.
     *
    ...
    /**
     * Validate the MCP input against the existing FormRequest rules.
     *
