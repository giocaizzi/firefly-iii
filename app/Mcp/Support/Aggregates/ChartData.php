...
/**
 * Lean chart-data lift for MCP (WIP_MCP D-036). Restricted to the three chart
 * types specified in §4.4: account_balances, category_expenses,
 * budget_vs_actual.
 *
 ...
 * compactness goal of the reducer pipeline (D-034) over the REST chart
